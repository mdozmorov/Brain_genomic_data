...
- Single-cell 3D genome (3646 cells) and transcriptome (3517 cells) of developing mouse brain across time course (7 stages, P1, P7, P14, P21, P28, P56, and P180). Cortex, hippocampus, visual cortex, visual cortex dark reared. Allele-specific Dip-C (diploid chromatin conformation capture), MALBAC-DT (multiple annealing and looping-based amplification cycles for digital transcriptomics). High correlation between A.B compartments and gene expression. 3D structure types correlate with transcriptional cell types (13 types, 3 main lineages - neurons, astrocytes, oligodendrocytes). Allele-specific 3D structure around imprinted genes affects transcription. Radial reconfiguration in neurons - inversion of euchromatin and inward movement of olfactory receptor genes, little correlation with gene expression. WGCNA modules of correlated genes, dynamics of those modules across time. Integration with published 3D genome, transcriptome, methylome, and chromatin accessibility data. A major 3D genome transformation between P7 (postnatal day 7) and P28 days, genetics determines 3D structure irrespectively of sensory stimuli (visual cortex in dark-reared animals), more in the text. Methods: hickit and [dip-c](https://github.com/tanlongzhi/dip-c) packages (haplotype-resolved contact maps, TAD calling, scA/B calculation, 3D structure modeling). Resources: [brainrnaseq.org](https://brainrnaseq.org/) - gene expression in human and mouse brain cell types (downloas as .csv); [Mouse sci-ATAC-seq Atlas](https://atlas.gs.washington.edu/mouse-atac/) - An atlas of chromatin accessibility in mouse at single cell resolution (download as peak counts, .rds formats). [Cahoy et al. 2028, Figure 6A,C](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC6671143/figure/F6/) - the top 60 genes up- and downregulated during astrocyte development. [Luo et al. 2017 Table S5](https://www.science.org/doi/10.1126/science.aan3351) - unmethylated regions in mouse brain cell types. [Lister et al. 2013, Table S2](https://www.science.org/doi/10.1126/science.1237905) - Genomic coordinates of mCH (non-CpG methylation) deserts. Data: [GSE162511](https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE162511) - Processed MALBAC-DT and Dip-C data (.hic, .txt, other formats, per cell). <details>
    <summary>Paper</summary>
    Tan, Longzhi, Wenping Ma, Honggui Wu, Yinghui Zheng, Dong Xing, Ritchie Chen, Xiang Li, Nicholas Daley, Karl Deisseroth, and X. Sunney Xie. “[Changes in Genome Architecture and Transcriptional Dynamics Progress Independently of Sensory Experience during Post-Natal Brain Development](https://doi.org/10.1016/j.cell.2020.12.032).” Cell, January 2021 <span data-badge-type="4" data-doi="10.1016/j.cell.2020.12.032" data-hide-no-mentions="true" class="altmetric-embed"> </span> 
</details>
...
- Aging brain single-nuclei multi-omics data (MERFISH spatial transcriptome, snmC-seq3 methylation and chromatin conformation), data in part from the Brain Initiative Cell Census Network (BICCN). 36 cell types, sex-specific and region-specific differences. Transposon demethylation (LINE1, others), strengthening of TAD boundaries, formation of smaller TADs, increased CTCF accessibility. Methylation changes hotspots. EpiAgingTransformer to predict gene expression age changes from seven epigenetic features (7 parallel heads), ATAC-seq is most predictive. [GSE132489](https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE132489), [GSE213262](https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE213262), [GSE292803](https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE292803), [GSE313770](https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE313770). [MERFISH](https://registry.opendata.aws/salk-aging-mouse-brain-epigeneti/). The cellular and genomic browsers: https://neomorph.salk.edu/SCMDAP/AgingMouseBrain and http://neomorph.salk.edu/aj2/pages/hchen/Mouse_AMB.php. [GitHub](https://github.com/rachelzeng98/aging-mouse-brain), [EpiAgingTransformer](https://github.com/Michaelvll/aging-gene-prediction). <details>
    <summary>Paper</summary>
    Zeng, Qiurui, Wenliang Wang, Wei Tian, et al. “Cell-Type-Specific Transposon Demethylation and TAD Remodeling in Aging Mouse Brain.” Cell, March 2026, S0092867426002229. https://doi.org/10.1016/j.cell.2026.02.015.
</details>

- Single-nucleus 3D multi-omics (snm3C-seq, scHiCcluster, consensus clustering) and methylome (snmC-seq3, [YAP pipeline](https://hq-1.gitbook.io/mc/)) atlas of the adult mouse brain. Very detailed analyses, methods, observations. Define cell type taxonomy across data modalities, TAD boundary association with long genes, gene regulatory network considering DMRs, genes, and TFs. Validation with MERFISH. [Data at the Neuroscience Multi-omic Data (NeMO) Archive](https://tinyurl.com/cembanemo). [GitHub](https://github.com/lhqing/wmb2023). <details>
    <summary>Paper</summary>
    Liu, Hanqing, Qiurui Zeng, Jingtian Zhou, Anna Bartlett, Bang-An Wang, Peter Berube, Wei Tian, et al. “Single-Cell DNA Methylome and 3D Multi-Omic Atlas of the Adult Mouse Brain.” Preprint. Genomics, April 18, 2023. https://doi.org/10.1101/2023.04.16.536509.
</details>
